...
Advanced named-parameter and dependency-checking patterns, plus the extended summary/resources, were moved to `references/advanced-defensive-techniques.md`. Read that reference when building larger production scripts or shell libraries.
