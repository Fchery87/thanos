...
/**
 * Resolve request auth for an out-of-band role completion through the
 ...
 */
export async function resolveRoleModelAuth<M extends ModelLike>(
...
/**
 * Resolve a role's model from a routing override, walking
 ...
 * toggled off.
 */
export function pickRoleModel<M extends ModelLike>(
